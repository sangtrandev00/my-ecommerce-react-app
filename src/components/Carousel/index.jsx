...
export default function Carousel(props) {
    const {cateListData} = props;
    console.log("cateListData", cateListData);
    return (
        <div className="container mx-auto">
            <div className="flex items-center justify-center w-full h-full py-24 sm:py-8 px-4">
                {/* Carousel for desktop and large size devices */}
                <CarouselProvider className="lg:block hidden" naturalSlideWidth={100} isIntrinsicHeight={true} totalSlides={cateListData.length} visibleSlides={4} step={1} infinite={true}>
                        ...
                        <div className="w-full h-full mx-auto overflow-x-hidden overflow-y-hidden">
                            <Slider>
                                <div id="slider" className="h-full flex lg:gap-8 md:gap-6 gap-14 items-center justify-start transition ease-out duration-700">
                                  {cateListData.map((cate, index) => {
                                    return (
                                        <Slide key={cate.id} index={index}>
                                        <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                            ...
                                            <div className="bg-gray-800 bg-opacity-30 absolute w-full h-full p-6">
                                                <h2 className="lg:text-xl leading-4 text-base lg:leading-5 text-white">{cate.name}</h2>
