...
export default function BlogItem() {
  ...
  return (
    <article className="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
          ...
          <h2 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><Link relative="path" to="1">Our first project with React</Link></h2>
