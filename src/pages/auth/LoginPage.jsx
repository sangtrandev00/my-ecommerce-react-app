  ...
  const handleEmailPasswordLogin = (e) => {
      ...
      setTimeout(() => {
        ...
        .then((UserCredential) => {
          ...
          // Handle notify feedback for customer here
      ...
      */}
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div className="mt-2 sm:mx-auto sm:w-full sm:max-w-sm">
          <form onSubmit={handleEmailPasswordLogin} className="space-y-6" action="#" method="POST">
            <div>
            ...
            <div>
              ...
              disabled = {isLoading ? true : false}
                type="submit"
                className={!isLoading ? "flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" : "flex w-full justify-center rounded-md bg-gray-400 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:bg-gray-400" }
              >
                Sign in
              </button>
            </div>
